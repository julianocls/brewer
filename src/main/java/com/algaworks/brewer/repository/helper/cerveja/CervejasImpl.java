...
public class CervejasImpl implements CervejasQueries {
	...
	public DadosEstoqueDTO dadosEstoque() {
		String query = "select new com.algaworks.brewer.dto.DadosEstoqueDTO(sum(valor * quantidadeEstoque), sum(quantidadeEstoque)) from Cerveja";
		return manager.createQuery(query, DadosEstoqueDTO.class).getSingleResult();
	}	
